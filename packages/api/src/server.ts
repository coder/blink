...
import { mountDisabledAIGateway } from "./routes/ai-gateway.server";
...
// the AI Gateway is disabled until we implement proper billing
mountDisabledAIGateway(api.basePath("/ai-gateway"));
